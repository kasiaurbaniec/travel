...
public class MainHandler implements UserCustomer {
    ...
    public void run() {
        ...
        trip1.setPrice(2500);
        trip2.setPrice(5500);
        to.addTrip("wig", trip1);
        to.addTrip("sri", trip2);
    ...
    public boolean removeCustomer() {
        ...
        try {
            Customer cust = to.findCustomerByName(clientName.toLowerCase());
            to.getSetOfCustomers().removeIf(x -> x.getName().toLowerCase().startsWith(clientName.toLowerCase()));
